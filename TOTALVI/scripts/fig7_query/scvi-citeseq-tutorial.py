...
vae.save("/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/full_model/11-09_run/scvi-tools-cite_reference_model", overwrite=True)
...
plt.legend()
plt.savefig("/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/full_model/11-09_run/figures/elbo.jpg")
...
vae_q.save("/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/full_model/11-09_run/scvi-tools-cite_query_model", overwrite=True)
