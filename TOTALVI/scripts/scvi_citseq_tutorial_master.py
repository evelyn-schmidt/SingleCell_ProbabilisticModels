...
# mkdir /storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/730_query/11-27/
# cd /storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/730_query/11-27/
# mkdir figures
# python3 ../../../scripts/no451/scarches_citseq_tutoral_no451.py 


ref_model = "/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/full_model/11-09_run/scvi-tools-cite_reference_model"
plots="/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/full_model/12-04/figures/"
query_model = "/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/full_model/11-09_run/scvi-tools-cite_query_model"

#ref_model = "/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/no_451_in_reference/11-09_run/scvi-tools-cite_reference_model"
#plots="/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/no_451_in_reference/11-18/figures/"
#query_model = "/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/no_451_in_reference/11-09_run/scvi-tools-cite_query_model"

#ref_model = "/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/730_query/11-09_run/scvi-tools-cite_reference_model"
#plots="/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/730_query/12-01/figures/"
#query_model = "/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/730_query/11-09_run/scvi-tools-cite_query_model"
...
# plots="/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/451_query/11-09_run/figures/verify-elbo.jpg"
...
# plots="/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/TOTALVI/models/3228_query/11-09_run/figures/verify-elbo.jpg"
...
adata = sc.read('/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/data/fig4_data/adata/fig4_Protein_folzconversion_prepped.h5ad')
...
# 730 query
# adata = adata[np.logical_or(adata.obs.batch == "3228", adata.obs.batch == "451")].copy()
...
vae = TOTALVI.load(ref_model, adata=adata) # Load model if you have previously trained
...
sc.pl.umap(
    ...
    frameon=False,
    ncols=1,
    save="_verify_inspect_reference"
)

# Map Query Date ##############################################################

query = sc.read('/storage1/fs1/mgriffit/Active/griffithlab/gc2596/e.schmidt/fig4_foltz/SingleCell_ProbabilisticModels/data/fig7_data/adata/fig7_Protein_folzconversion_prepped.h5ad')

# 3228 query
# query = adata[np.logical_or(adata.obs.batch == "3228"].copy()
# 730 query
query = adata[np.logical_or(adata.obs.batch == "730")].copy()
...
sc.pl.umap(
    query,
    color=["celltype.l2", "leiden"],
    frameon=False,
    ncols=1,
    save="_verify_evaluate_predictions"
)
...
sc.pl.embedding(
    ...
    frameon=False,
    ncols=1,
    save="_verify_ref_visualization"
)
...
# Unifiying the Cell Types
# fig7 celltypes: 'CD56bright', 'CD56dim', 'ML1', 'ML2', 'Proliferating', 'nonNK', 'trans'
# fig4 celltypes: 'CD56bright', 'CD56dim', 'ML1', 'ML2', 'NKG2Cpos', 'Proliferating1', 'Proliferating2', 'nonNK'
# trans and NKG2Cpos to other, and combining 'Proliferating1', 'Proliferating2' to 'Proliferating'

query.obs["ref_celltypes_unified"] = query.obs["leiden"].replace({
        "trans" : "Other"
    })
query.obs["celltypes_unified_predicted"] = query.obs["celltype.l2"].replace({
        "NKG2Cpos" : "Other",
	"Proliferating1" : "Proliferating",
	"Proliferating2" : "Proliferating",
    })

if set(query.obs["ref_celltypes_unified"].unique()) == set(query.obs["celltypes_unified_predicted"].unique()):
